...
set TOOL_JAVA_CMD_QUOTED=!JAVA_CMD_QUOTED! !JVM_ARGS! -jar "!WLP_INSTALL_DIR!\bin\xmlBinding/tools/ws-xjc.jar"
...
if exist "!WLP_INSTALL_DIR!\lib\tools-internal/xmlBinding/xjc.bat" goto:script
...
:script
set JAVA_RC=
call "!WLP_INSTALL_DIR!\lib\tools-internal/xmlBinding/xjc" %*
if defined JAVA_RC (
  set RC=!JAVA_RC!
  call:javaCmdResult
)
