...
set WLP_INSTALL_DIR=!CURRENT_DIR:~0,-16!
...
set TOOL_JAVA_CMD_QUOTED=!JAVA_CMD_QUOTED! !JVM_ARGS! -jar "!WLP_INSTALL_DIR!\bin\xmlBinding/tools/ws-schemagen.jar"
...
if exist "!WLP_INSTALL_DIR!\lib\tools-internal/xmlBinding/schemagen.bat" goto:script
...
:script
set JAVA_RC=
call "!WLP_INSTALL_DIR!\lib\tools-internal/xmlBinding/schemagen" %*
if defined JAVA_RC (
  set RC=!JAVA_RC!
  call:javaCmdResult
)
